...
class Champion {
	...
	public Champion(String name, int charcater, int army, double health, double[] attackDamage,
...
//		System.out.println("1. Add your attack damage;");
		if (charcater == 3) {
			System.out.println("Recover your champion's health.");
		}else {
			System.out.println("Attack the target with ability damage.");			
		}
	}
...
//				System.out.println(" point damage.");
			...
			System.err.println(this.name + " uses " + this.abilityName[0] + " adding "+ addHealth +" point health to " + target.getName() + ".");
			target.health = target.health + addHealth;
		}
